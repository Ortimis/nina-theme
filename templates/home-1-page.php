<?php
/**
 * Template Name: Home 3 col Slider, Magazine, Sidebar
 *
			...
			if ( have_posts() ) : ?>
				...
				<div class="row">
					<div class="masonry" id="post-load">
						...
						<?php
							function rht1_grid_sizer_class( $classes ) {
								$classes = array();
								if ( is_active_sidebar( 'sidebar-1' ) ) {

									$classes[] = esc_attr( 'col-sm-12' );

								} else {

									$classes[] = esc_attr( 'col-sm-6' );
						...
						<div class="grid-sizer <?php rht1_grid_sizer_class(); ?>"></div>
